...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		// copy and append last point utils the length matches the end length
		if (start.length) {
...
if (useCanVG) {
	 ...
	 * the implementation from SvgRenderer will not be merged in utils first render.
	 */
			...
			this.label =
				this.axis.chart.renderer.text(str, 0, 0, options.useHTML)		// dummy positions, actual position updated with setOffset method in columnseries
					...
					.attr({
						...
						visibility: HIDDEN					// hidden utils setOffset is called
					})				
...
Axis.prototype = {
	 ...
	 * updated axis.pointRange or series.pointRange. The data can't be processed utils
...
Chart.prototype = {
	...
	redraw: function (animation) {
		...
		// Fire callbacks that are put on hold utils after the redraw
	...
	/**
	 * VML namespaces can't be added utils after complete. Listening
	...
	isReadyToRender: function () {
		...
		/*jslint eqeq: false*/
			if (useCanVG) {
				// Delay rendering utils canvg library is downloaded and ready
...
var PieSeries = {
	...
	drawDataLabels: function () {
		...
		// Do not apply the final placement and draw the connectors utils we have verified
